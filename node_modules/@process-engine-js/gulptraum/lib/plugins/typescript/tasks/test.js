...
function generate(gulp, config, gulptraum) {
  ...
  gulptraum.task('test-typescript-build', {
    ...
    let targetFolder = path.resolve(config.paths.root, 'node_modules');
    if (config.packageName.charAt(0) === '@') {
      targetFolder = path.join(targetFolder, config.packageName.split('/')[0]);
    }
